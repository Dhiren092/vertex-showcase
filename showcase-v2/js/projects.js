/* ============================================================
   ...
   ------------------------------------------------------------
   This file is the single source of truth for the showcase (V2).
   To add a project:
     1. Drop its images into  showcase-v2/images/showcase/<folder>/
     2. Add one object to the PROJECTS array below.
   The lightbox browses every image of the active category in the
   order the projects appear here.

   Fields:
     slug      unique id for the project
     title     project title (shown in the lightbox caption)
     category  one of: "Web design", "Mobile application",
               "Branding design" (the filter chips in index.html)
     cover     project thumbnail (unused on the V2 first screen —
               category covers live in js/grid.js COVERS)
     images    images shown in the lightbox, in order
     tags      keywords (unused in V2)
   ============================================================ */
